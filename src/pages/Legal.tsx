...
const tosItems = [
  { title: "1. Aceptación de los términos", content: "Al acceder y utilizar la plataforma VENATEL, usted acepta estar sujeto a estos Términos de Servicio. Si no está de acuerdo con alguna parte de estos términos, no podrá acceder al servicio. Nos reservamos el derecho de actualizar estos términos en cualquier momento, notificando a los usuarios de cambios significativos." },
  { title: "2. Descripción del servicio", content: "VENATEL es una plataforma de software como servicio (SaaS) de gestión hotelera que permite a los usuarios administrar reservas, habitaciones, huéspedes, inventario, servicios y finanzas de establecimientos hoteleros. El servicio se proporciona \"tal cual\" y \"según disponibilidad\"." },
  { title: "3. Registro y cuenta de usuario", content: "Para utilizar VENATEL, debe crear una cuenta proporcionando información precisa y completa. Usted es responsable de mantener la confidencialidad de sus credenciales de acceso y de todas las actividades que ocurran bajo su cuenta." },
  { title: "4. Planes, pagos y cancelación", content: "VENATEL ofrece distintos planes de suscripción con precios y características detallados en la página de precios. Los pagos se procesan mensualmente. Puede cancelar su suscripción en cualquier momento sin penalizaciones, manteniendo acceso hasta el final del período pagado." },
  { title: "5. Uso aceptable", content: "Usted se compromete a utilizar VENATEL únicamente para fines legítimos de gestión hotelera. Queda prohibido el uso del servicio para actividades ilegales, distribución de malware, o cualquier acción que pueda dañar la plataforma o a otros usuarios." },
  { title: "6. Propiedad intelectual", content: "Todo el contenido, diseño, código fuente, marcas registradas y demás elementos de propiedad intelectual de VENATEL pertenecen exclusivamente a la empresa. Los datos ingresados por los usuarios siguen siendo propiedad de cada usuario." },
  { title: "7. Limitación de responsabilidad", content: "VENATEL no será responsable por daños indirectos, incidentales, especiales o consecuentes que surjan del uso o la imposibilidad de uso del servicio. Nuestra responsabilidad total no excederá el monto pagado por el usuario en los últimos 12 meses." },
...
const privacyItems = [
  ...
  { title: "4. Cookies", content: "VENATEL utiliza únicamente cookies técnicas esenciales para el funcionamiento del servicio, como sesiones de autenticación. No utilizamos cookies de rastreo, publicidad ni análisis de terceros." },
