...
const plans = [
  {
    ...
    items: [
      "Módulos de reservas, huéspedes, pagos, extras e inventario",
...
const faqs = [
  ...
  },
  {
    ...
    a: "Toda la información se almacena en infraestructura de base de datos empresarial con encriptación en tránsito y en reposo. No utilizamos cookies de rastreo, no compartimos la información de nuestros clientes con terceros y NO la comercializamos.",
  },
  {
